...
urlpatterns = [
    ...
    path('subir_comprobantes_especial/', views.subir_comprobante_especial, name='subir_comprobantes_especial'),
    ...
    path('exportar-excel/', views.exportar_asistencias_encargado_excel, name='exportar_asistencias_excel_encargado'),
